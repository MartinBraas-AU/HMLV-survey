...
if __name__ == "__main__":
    ...
    defaults = config["defaults"]["fetch_citing_papers"]
    ...
    collector = HMLVCitationCollector(
        # Non-failed input path from config: defaults["input_non_failed"]
        input_json=resolve_from_root(repo_root, defaults["input_failed"]),
