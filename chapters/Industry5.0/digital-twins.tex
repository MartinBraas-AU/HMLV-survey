...
A \ac{dt} can be defined as a digital representation of a physical entity, called a \ac{pt}.
...
Thus, a digital representation can be either a digital model, a digital shadow, or a \ac{dt}, enabling a clear definition of \ac{dt} technology in its level of integration.
...
\begin{itemize}
    ...
    \item Wang et al. (2023) \cite{Wang10090432} presents the concept of Internet of Digital Twins (IoDT), its architecture, enabling technologies, and security/privacy issues.
      IoDT is an interconnected system of a number of \ac{dt}s and Physical entities synchronized through intra-twin semantic communication.
...
While also attending to the computational burden to perform complex computations on large volumes of data at high velocity, cite{Predictive maintenance using \ac{dt}s: A systematic literature review} poses a challenge.
