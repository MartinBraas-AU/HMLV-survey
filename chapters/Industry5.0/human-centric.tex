...
- Industry 5.0 in Manufacturing: Enhancing Resilience and Responsibility through \ac{ai}-Driven Predictive Maintenance, Quality Control, and Supply Chain Optimization
- \ac{dt}s for Industry 5.0: Unlocking the Human Potential (Genlæs)
- A \ac{dt} Driven Human-Centric Ecosystem for Industry 5.0 (Genlæs)
