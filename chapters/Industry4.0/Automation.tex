...
Early automation relied on fixed robotic arms, conveyor systems, and \ac{plc}s, which were efficient for mass production but inflexible in the face of product variability~\cite{brettel-how-virtualization-decentralization-and-networking, monsori-cpps-roots-expectations-rnd-challenges}.
...
One important development has been the rise of \ac{cobots}, which integrate advanced sensing, force control, and safety mechanisms to share workspaces with human operators~\cite{villani-survey-on-human-robot-collaboration-in-industrial-settings}.
...
While the concept of \ac{cobots} leans more towards the human-centric ideals of Industry 5.0, the improvement in quality, efficiency and partial automation also makes it relevant to the Industry 4.0 industrial paradigm.

\subsection{Intelligence and Adaptivity in Automation}

Advances in \ac{ai} and \ac{ml} extend the scope of robotics beyond repetitive automation.
...
Integration into wider \ac{cps} and \ac{iot} infrastructures is further slowed by the lack of universal standards, a theme which is common across Industry 4.0 technologies~\cite{monsori-cpps-roots-expectations-rnd-challenges,xu-industry-40-state-of-the-art-and-future-trends}.
