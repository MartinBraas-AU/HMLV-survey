...
CPS are seen as essential for enabling the responsiveness, flexibility, and adaptability required in High-Mix Low-Volume (HMLV) manufacturing, because they allow systems to sense context, respond in close to real time, and reconfigure or adjust behavior when parts, batches, or processes change.

\subsection{Role of CPS in Manufacturing}

In manufacturing, CPS integrates production equipment with computation and connectivity, enabling continuous monitoring optimization, and reconfiguration. For HMLV contexts, where product variation and small batch sizes are common, CPS make it possible to:
...
\begin{itemize}
    ...
    \item Scalability of CPS solutions for Small and Medium-sized Enterprises (SMEs) and HMLV contexts.
